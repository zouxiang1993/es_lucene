...
/**
 * An {@link LeafReader} which supports sorting documents by a given
...
class SortingLeafReader extends FilterLeafReader {
  ...
  static class SortingFields extends FilterFields {
    ...
    public SortingFields(final Fields in, FieldInfos infos, DocMap docMap) {
      super(in);
      this.docMap = docMap;
      this.infos = infos;
    }
  ...
  private static class SortingTerms extends FilterTerms {
    ...
    public SortingTerms(final Terms in, IndexOptions indexOptions, final DocMap docMap) {
      super(in);
      this.docMap = docMap;
  ...
  private static class SortingTermsEnum extends FilterTermsEnum {
    ...
    final DocMap docMap; // pkg-protected to avoid synthetic accessor methods
    private final IndexOptions indexOptions;
    private final boolean hasPositions;

    public SortingTermsEnum(final TermsEnum in, DocMap docMap, IndexOptions indexOptions, boolean hasPositions) {
      super(in);
      this.docMap = docMap;
      this.indexOptions = indexOptions;
  ...
  private static class SortingBinaryDocValues extends BinaryDocValues {
    ...
    SortingBinaryDocValues(BinaryDocValues in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  private static class SortingNumericDocValues extends NumericDocValues {
    ...
    public SortingNumericDocValues(final NumericDocValues in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  private static class SortingBits implements Bits {
    ...
    public SortingBits(final Bits in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  private static class SortingPointValues extends PointValues {
    ...
    public SortingPointValues(final PointValues in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  private static class SortingSortedDocValues extends SortedDocValues {
    ...
    SortingSortedDocValues(SortedDocValues in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  private static class SortingSortedSetDocValues extends SortedSetDocValues {
    ...
    SortingSortedSetDocValues(SortedSetDocValues in, DocMap docMap) {
      this.in = in;
      this.docMap = docMap;
    }
  ...
  static class SortingDocsEnum extends FilterPostingsEnum {
    ...
    SortingDocsEnum(int maxDoc, SortingDocsEnum reuse, final PostingsEnum in, boolean withFreqs, final DocMap docMap) throws IOException {
      super(in);
      this.maxDoc = maxDoc;
  ...
  static class SortingPostingsEnum extends FilterPostingsEnum {
    ...
    SortingPostingsEnum(int maxDoc, SortingPostingsEnum reuse, final PostingsEnum in, DocMap docMap, boolean storeOffsets) throws IOException {
      super(in);
      this.maxDoc = maxDoc;
  ...
  /** Expert: same as {@link #wrap(LeafReader, Sort)} but operates directly on a {@link DocMap}. */
  static LeafReader wrap(LeafReader reader, DocMap docMap) {
    if (docMap == null) {
  ...
  private SortingLeafReader(final LeafReader in, final DocMap docMap) {
    super(in);
    this.docMap = docMap;
  }
