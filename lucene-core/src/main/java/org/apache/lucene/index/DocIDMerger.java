...
public abstract class DocIDMerger<T extends DocIDMerger.Sub> {
  ...
  public static <T extends Sub> DocIDMerger<T> of(List<T> subs, int maxCount, boolean indexIsSorted) {
  ...
  public static <T extends Sub> DocIDMerger<T> of(List<T> subs, boolean indexIsSorted) {
  ...
  private static class SequentialDocIDMerger<T extends Sub> extends DocIDMerger<T> {
  ...
  private static class SortedDocIDMerger<T extends Sub> extends DocIDMerger<T> {
