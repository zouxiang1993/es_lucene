...
public final class Util {
  ...
  public static class FSTPath<T> {
    ...
    /** Sole constructor */
    public FSTPath(T output, Arc<T> arc, IntsRefBuilder input) {
      this(output, arc, input, 0, null, -1);
    }

    public FSTPath(T output, Arc<T> arc, IntsRefBuilder input, float boost, CharSequence context, int payload) {
