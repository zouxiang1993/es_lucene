...
public final class SynonymQuery extends Query {
  ...
  class SynonymWeight extends Weight {
    ...
    public Scorer scorer(LeafReaderContext context) throws IOException {
      SimScorer simScorer = similarity.simScorer(simWeight, context);
  ...
  static class SynonymScorer extends DisjunctionScorer {
    private final SimScorer similarity;
    
    SynonymScorer(SimScorer similarity, Weight weight, List<Scorer> subScorers) {
