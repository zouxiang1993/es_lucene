...
public abstract class MultiTermQuery extends Query {
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsScoringBooleanQueryRewrite extends TopTermsRewrite<Builder> {
    ...
    @Override
    protected Builder getTopLevelBuilder() {
    ...
    @Override
    protected void addClause(Builder topLevel, Term term, int docCount, float boost, TermContext states) {
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsBoostOnlyBooleanQueryRewrite extends TopTermsRewrite<Builder> {
    ...
    @Override
    protected void addClause(Builder topLevel, Term term, int docFreq, float boost, TermContext states) {
