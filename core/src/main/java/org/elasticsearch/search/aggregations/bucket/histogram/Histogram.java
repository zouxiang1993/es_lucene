...
public interface Histogram extends MultiBucketsAggregation {
    ...
    abstract class Order implements ToXContent {
        ...
        public static final Order KEY_ASC = new InternalOrder((byte) 1, "_key", true, new Comparator<Bucket>() {
            @Override
        ...
        public static final Order KEY_DESC = new InternalOrder((byte) 2, "_key", false, new Comparator<Bucket>() {
            @Override
            public int compare(Bucket b1, Bucket b2) {
        ...
        public static final Order COUNT_ASC = new InternalOrder((byte) 3, "_count", true, new Comparator<Bucket>() {
            @Override
            public int compare(Bucket b1, Bucket b2) {
        ...
        public static final Order COUNT_DESC = new InternalOrder((byte) 4, "_count", false, new Comparator<Bucket>() {
            @Override
            public int compare(Bucket b1, Bucket b2) {
