...
public class SignificantTermsAggregationBuilder extends ValuesSourceAggregationBuilder<ValuesSource, SignificantTermsAggregationBuilder> {
    ...
    static final BucketCountThresholds DEFAULT_BUCKET_COUNT_THRESHOLDS = new BucketCountThresholds(
            3, 0, 10, -1);
    ...
    private BucketCountThresholds bucketCountThresholds = new BucketCountThresholds(DEFAULT_BUCKET_COUNT_THRESHOLDS);
    ...
    protected BucketCountThresholds getBucketCountThresholds() {
        return new BucketCountThresholds(bucketCountThresholds);
    }

    public BucketCountThresholds bucketCountThresholds() {
        return bucketCountThresholds;
    }

    public SignificantTermsAggregationBuilder bucketCountThresholds(BucketCountThresholds bucketCountThresholds) {
