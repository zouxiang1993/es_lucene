...
public class InternalDateRange extends InternalRange<InternalDateRange.Bucket, InternalDateRange> {
    ...
    public static class Factory extends InternalRange.Factory<Bucket, InternalDateRange> {
        @Override
        ...
        @Override
        public InternalDateRange create(String name, List<Bucket> ranges, DocValueFormat formatter, boolean keyed,
    ...
    InternalDateRange(String name, List<Bucket> ranges, DocValueFormat formatter, boolean keyed,
            List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData) {
