...
public final class GeoQueryContext implements ToXContent {
    ...
    private static ObjectParser<Builder, Void> GEO_CONTEXT_PARSER = new ObjectParser<>(NAME, null);
    static {
        ...
        GEO_CONTEXT_PARSER.declareInt(Builder::setBoost, new ParseField(CONTEXT_BOOST));
        // TODO : add string support for precision for GeoUtils.geoHashLevelsForPrecision()
        GEO_CONTEXT_PARSER.declareInt(Builder::setPrecision, new ParseField(CONTEXT_PRECISION));
        // TODO : add string array support for precision for GeoUtils.geoHashLevelsForPrecision()
        GEO_CONTEXT_PARSER.declareIntArray(Builder::setNeighbours, new ParseField(CONTEXT_NEIGHBOURS));
        GEO_CONTEXT_PARSER.declareDouble(Builder::setLat, new ParseField("lat"));
        GEO_CONTEXT_PARSER.declareDouble(Builder::setLon, new ParseField("lon"));
    }
