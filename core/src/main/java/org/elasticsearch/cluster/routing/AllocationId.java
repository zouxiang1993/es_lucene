...
public class AllocationId implements ToXContent, Writeable {
    ...
    private static final ObjectParser<Builder, Void> ALLOCATION_ID_PARSER = new ObjectParser<>(
            "allocationId");

    static {
        ALLOCATION_ID_PARSER.declareString(Builder::setId, new ParseField(ID_KEY));
        ALLOCATION_ID_PARSER.declareString(Builder::setRelocationId, new ParseField(RELOCATION_ID_KEY));
    }
