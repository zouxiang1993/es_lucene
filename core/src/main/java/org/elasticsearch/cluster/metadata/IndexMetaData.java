...
public class IndexMetaData implements Diffable<IndexMetaData>, ToXContent {
    ...
    public static final Setting<Integer> INDEX_FORMAT_SETTING =
            Setting.intSetting(INDEX_FORMAT, 0, Property.IndexScope, Property.Final);
    ...
    public static class Builder {
        ...
        public static void toXContent(IndexMetaData indexMetaData, XContentBuilder builder, Params params) throws IOException {
     ...
     * {@link #isIndexUsingShadowReplicas(Settings)}.
     */
    ...
    private static final Params FORMAT_PARAMS = new MapParams(Collections.singletonMap("binary", "true"));
