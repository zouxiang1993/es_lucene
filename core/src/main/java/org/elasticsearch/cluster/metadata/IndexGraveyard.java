...
public final class IndexGraveyard implements MetaData.Custom {
    ...
    public static Builder builder(final IndexGraveyard graveyard) {
    ...
    public static final class Tombstone implements ToXContent, Writeable {
        ...
        private static final ObjectParser<Builder, Void> TOMBSTONE_PARSER;
        static {
            TOMBSTONE_PARSER = new ObjectParser<>("tombstoneEntry", Builder::new);
            TOMBSTONE_PARSER.declareObject(Builder::index, (parser, context) -> Index.fromXContent(parser),
                    new ParseField(INDEX_KEY));
            TOMBSTONE_PARSER.declareLong(Builder::deleteDateInMillis, new ParseField(DELETE_DATE_IN_MILLIS_KEY));
