...
public class CommitPoint {
    ...
    public static final CommitPoint NULL = new CommitPoint(-1, "_null_", Type.GENERATED, Collections.<FileInfo>emptyList(), Collections.<FileInfo>emptyList());
    ...
    public FileInfo findNameFile(String name) {
        FileInfo fileInfo = findNameIndexFile(name);
        if (fileInfo != null) {
            return fileInfo;
        }
