...
public class BoolQueryBuilder extends AbstractQueryBuilder<BoolQueryBuilder> {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        ...
        addBooleanClauses(context, booleanQueryBuilder, mustClauses, Occur.MUST);
        addBooleanClauses(context, booleanQueryBuilder, mustNotClauses, Occur.MUST_NOT);
        addBooleanClauses(context, booleanQueryBuilder, shouldClauses, Occur.SHOULD);
        addBooleanClauses(context, booleanQueryBuilder, filterClauses, Occur.FILTER);
