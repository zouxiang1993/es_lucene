...
public class Store extends AbstractIndexShardComponent implements Closeable, RefCounted {
    ...
    public void cleanupAndVerify(String reason, MetadataSnapshot sourceMetaData) throws IOException {
        ...
        try (Lock writeLock = directory.obtainLock(IndexWriter.WRITE_LOCK_NAME)) {
            ...
            final MetadataSnapshot metadataOrEmpty = getMetadata(null);
    ...
    public interface OnClose extends Consumer<ShardLock> {
        OnClose EMPTY = new OnClose() {
            /**
             * This method is called while the provided {@link ShardLock} is held.
    ...
    private static class StoreStatsCache extends SingleObjectCache<StoreStats> {
        ...
        StoreStatsCache(TimeValue refreshInterval, Directory directory, DirectoryService directoryService) throws IOException {
