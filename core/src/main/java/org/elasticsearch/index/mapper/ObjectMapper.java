...
public class ObjectMapper extends Mapper implements Cloneable {
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        protected static boolean parseObjectOrDocumentTypeProperties(String fieldName, Object fieldNode, ParserContext parserContext, Builder builder) {
        ...
        protected static void parseProperties(Builder objBuilder, Map<String, Object> propsNode, ParserContext parserContext) {
