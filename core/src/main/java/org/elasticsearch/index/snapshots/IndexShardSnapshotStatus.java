...
public class IndexShardSnapshotStatus {
    ...
    /**
     * Sets the reason for the failure if the snapshot is in the {@link Stage#FAILURE} state
     */
    ...
    /**
     * Returns the reason for the failure if the snapshot is in the {@link Stage#FAILURE} state
     */
