...
final class JNAKernel32Library {
     ...
     * @throws UnsatisfiedLinkError if the Kernel32 library is not loaded or if the native function is not found
     * @throws NoClassDefFoundError if the library for native calls is missing
     */
