...
public abstract class ReplicaShardAllocator extends BaseGatewayShardAllocator {
                ...
                if (matchingNodes.getNodeWithHighestMatch() != null) {
                    ...
                    if (currentNode.equals(nodeWithHighestMatch) == false
                        ...
                        UnassignedInfo unassignedInfo = new UnassignedInfo(UnassignedInfo.Reason.REALLOCATED_REPLICA,
                            ...
                            null, 0, allocation.getCurrentNanoTime(), System.currentTimeMillis(), false, AllocationStatus.NO_ATTEMPT);
    ...
    public AllocateUnassignedDecision makeAllocationDecision(final ShardRouting unassignedShard,
        ...
        if (allocateDecision.type() != Decision.Type.YES
            ...
            return AllocateUnassignedDecision.no(AllocationStatus.fromDecision(allocateDecision.type()),
        ...
        if (allocateDecision.type() != Decision.Type.YES) {
            return AllocateUnassignedDecision.no(AllocationStatus.fromDecision(allocateDecision.type()), nodeDecisions);
