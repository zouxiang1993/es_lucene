 ...
 *
 *  Description:
 *  copy from lucene-test-framework-6.6.1.jar!org.apache.lucene.analysis.TokenStreamToDot
 *  用于将TokenStream绘制成图形，可用graphviz展示
 *
 *  使用方法：
 *         final StringWriter sw = new StringWriter();
 *         new TokenStreamToDot(text, analyzer.tokenStream("", text), new PrintWriter(sw)).toDot();
