...
public abstract class NumberRangePrefixTree extends SpatialPrefixTree {
   ...
   * that. This is the reverse of {@link #toObject(UnitNRShape)}. */
   ...
   * be normalized, and so sometimes a {@link UnitNRShape}
   * will be returned, other times a
   * {@link SpanUnitsNRShape} will be.
   *
  ...
  public class SpanUnitsNRShape implements NRShape {
     ...
     * {@link #toRangeShape(UnitNRShape, UnitNRShape)}. */
