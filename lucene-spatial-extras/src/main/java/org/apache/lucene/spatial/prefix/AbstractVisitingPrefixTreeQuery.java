...
public abstract class AbstractVisitingPrefixTreeQuery extends AbstractPrefixTreeQuery {
   ...
   * process, calling {@link #findSubCellsToVisit(Cell)}
   ...
   * {@link #visitPrefix(Cell)} is called. At
   * some depths, of the tree, the algorithm switches to a scanning mode that
   * calls {@link #visitScanned(Cell)}
  ...
  */
    ...
    /** Called initially, and whenever {@link #visitPrefix(Cell)}
     * returns true. */
     ...
     * {@link #visitLeaf(Cell)} or
     * {@link #visitPrefix(Cell)}.
     */
