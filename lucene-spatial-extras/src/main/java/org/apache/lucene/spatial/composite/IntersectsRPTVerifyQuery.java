...
public class IntersectsRPTVerifyQuery extends Query {
  ...
  private static class IntersectsDifferentiatingQuery extends AbstractVisitingPrefixTreeQuery {
    ...
    IntersectsDifferentiatingVisitor compute(LeafReaderContext context)
        throws IOException {
      final IntersectsDifferentiatingVisitor result =
          new IntersectsDifferentiatingVisitor(context);
