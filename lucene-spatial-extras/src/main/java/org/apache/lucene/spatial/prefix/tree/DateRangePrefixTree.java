 ...
 * {@link GregorianCalendar}; others could probably be supported easily.
 * <p>
...
public class DateRangePrefixTree extends NumberRangePrefixTree {
  ...
  */
  ...
  /**
   * A Calendar instance compatible with {@link ZonedDateTime} as seen from
  ...
  /** Calendar utility method:
   * Returns the spatial prefix tree level for the corresponding {@link Calendar} field, such as
   * {@link Calendar#YEAR}.  If there's no match, the next greatest level is returned as a negative value.
   */
  ...
  /** Calendar utility method:
   * The reverse of {@link #toString(Calendar)}. It will only set the fields found, leaving
