 ...
 * <pre>
 *
 *  File: ExtendSynonymFilterFactory.java
 *
 ...
 * </pre>
 */
public class ExtendSynonymFilterFactory extends AbstractTokenFilterFactory {

    protected final SynonymMap synonymMap;
    protected final boolean ignoreCase;
    private static Logger logger = ESLoggerFactory.getLogger("extend-synonyms");

    public ExtendSynonymFilterFactory(IndexSettings indexSettings, Environment environment, String name, Settings settings, AnalysisRegistry analysisRegistry) throws IOException {
