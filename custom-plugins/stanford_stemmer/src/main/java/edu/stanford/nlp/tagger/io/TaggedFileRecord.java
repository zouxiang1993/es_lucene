...
//import edu.stanford.nlp.io.TaggedFileReader;
//import edu.stanford.nlp.io.TextTaggedFileReader;
...
public class TaggedFileRecord {
  ...
  public TaggedFileReader reader() {
    ...
    case TREES:
      throw new RuntimeException("TreeTaggedFileReader是必需的");
//      return new TreeTaggedFileReader(this);
    case TSV:
      throw new RuntimeException("TSVTaggedFileReader是必需的");
